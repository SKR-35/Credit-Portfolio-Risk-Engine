...
DATA_PATH = Path("data/processed/train_static_person_features.parquet")
...
print("Training XGBoost static + person model...")
...
print("=" * 80)
print("STATIC + PERSON XGBOOST SUMMARY")
print("=" * 80)
...
model_path = MODEL_DIR / "static_person_xgboost.joblib"
importance_path = REPORT_DIR / "feature_importance_static_person_xgboost.csv"
summary_path = REPORT_DIR / "static_person_xgboost_summary.json"
