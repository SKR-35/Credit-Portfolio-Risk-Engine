...
print(
    "Training XGBoost static + person + applprev model..."
)
...
print("=" * 80)
print("STATIC + PERSON + APPLPREV XGBOOST SUMMARY")
print("=" * 80)
...
model_path = (
    MODEL_DIR /
    "static_person_applprev_xgboost.joblib"
)

importance_path = (
    REPORT_DIR /
    "feature_importance_static_person_applprev.csv"
)

summary_path = (
    REPORT_DIR /
    "static_person_applprev_summary.json"
)
