...
# Avoid a full DataFrame-wide replace here; it can trigger a large memory copy.
# XGBoost handles NaN natively. If +/-inf appears later, clean those columns selectively.
...
print(
    "Training XGBoost static + person + applprev + bureau_b + bureau_a1 model..."
)
...
print("=" * 80)
print("STATIC + PERSON + APPLPREV + BUREAU_B + BUREAU_A1 XGBOOST SUMMARY")
print("=" * 80)
...
model_path = (
    MODEL_DIR /
    "static_person_applprev_bureaub_a1_xgboost.joblib"
)

importance_path = (
    REPORT_DIR /
    "feature_importance_static_person_applprev_bureaub_a1.csv"
)

summary_path = (
    REPORT_DIR /
    "static_person_applprev_bureaub_a1_summary.json"
)
