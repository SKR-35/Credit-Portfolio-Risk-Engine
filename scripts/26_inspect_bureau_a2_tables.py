"""
Inspect Bureau A2 parquet tables.

Purpose:
--------
Bureau A2 contains detailed payment / collateral-level records and can be very large.
Before feature engineering, this script inspects each A2 file separately and writes
a report to reports/inspection/.

This is part of the v0.1 experimentation phase.
"""
